    ...
    <Link href='/waitlist' tabIndex={-1}>
      <Card className='relative overflow-hidden cursor-pointer hover:shadow-xl transition-all duration-300 transform bg-black border-0'>
        <div className='absolute inset-0 overflow-hidden'>
          <div className='absolute -bottom-6 -right-6 w-48 h-48 bg-gradient-to-br from-green-500 to-blue-500 rounded-full opacity-30 blur-xl'></div>
          <div className='absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-green-500 to-blue-500 rounded-full opacity-20 blur-lg transform -translate-x-1/2 -translate-y-1/2'></div>
        </div>
          ...
          <div className='relative z-10'>
            <div className='flex items-center mb-3'>
              <div className='flex items-center gap-2'>
                ...
                <span className='text-xs bg-green-900/40 px-2 py-1 rounded-full font-medium text-green-500'>Soon</span>
              </div>
            </div>
